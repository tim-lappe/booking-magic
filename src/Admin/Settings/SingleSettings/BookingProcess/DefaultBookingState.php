...
class DefaultBookingState extends \TLBM\Admin\Settings\SingleSettings\SettingsBase {
		...
		<label>
			<select name="<?php echo $this->option_name ?>">
				...
				foreach ($states as $state): ?>
					<option value="<?php echo $state['name'] ?>" <?php selected($state['name'] == get_option($this->option_name, $this->default_value)) ?>><?php echo $state['title'] ?></option>
				<?php endforeach; ?>
			</select>
		</label>
		<?php
