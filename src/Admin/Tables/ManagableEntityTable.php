...
abstract class ManagableEntityTable extends TableBase
{
    ...
    protected function getColumns(): array
    {
        return array(
            ...
            new Column("date_edited", __('Date last edited', TLBM_TEXT_DOMAIN), true, function ($item) {
                /**
            ...
            new Column("date_created", __('Date created', TLBM_TEXT_DOMAIN), true, function ($item) {
                /**
                 * @var ManageableEntity $item
                 */
