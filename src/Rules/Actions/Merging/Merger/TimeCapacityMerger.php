...
class TimeCapacityMerger extends Merger
{
     ...
     */
    public function sumUpResults(string $term, array $calendarIds, MergeResultInterface $mergeResultSummedUp, MergeResultInterface $mergeResultToAdd)
    {
        if($term == "timeCapacities" && $mergeResultSummedUp instanceof TimedCapacityResult && $mergeResultToAdd instanceof TimedCapacityResult) {
            if ($mergeResultSummedUp->getHour() == $mergeResultToAdd->getHour() &&
                $mergeResultSummedUp->getMinute() == $mergeResultToAdd->getMinute()) {
    ...
    {
        if($term == "timeCapacities" && $mergeResult instanceof TimedCapacityResult) {
