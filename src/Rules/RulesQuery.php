...
class RulesQuery {
    ...
    public function __construct(DateTime $date_time = null) {
    ...
    private function getQueryforSingle(?DateTime $date_time = null): QueryBuilder {
        ...
        if($this->calendar_id) {
            ...
            $calendar_selection_where->add("calendarSelection.selection_mode = '" . TLBM_CALENDAR_SELECTION_TYPE_ALL . "'");
        ...
        if($date_time) {
            ...
            $mofr = $weekday <= 5;
            $labels = array_keys(Labels::GetWeekdayLabels());
