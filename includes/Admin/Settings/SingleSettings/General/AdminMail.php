...
namespace TL_Booking\Admin\Settings\SingleSettings\General;
...
class AdminMail extends SettingsBase {
	...
	public function PrintField() {
		?>
		<label>
			<input type="email" class="regular-text" name="<?php echo $this->option_name ?>" value="<?php echo get_option($this->option_name); ?>">
		</label>
		<?php
	}
}