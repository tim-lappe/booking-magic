...
use DateTime;
use TL_Booking\Admin\FormEditor\Formeditor;
...
class EnqueueAssets {
	...
	public function global_enqueue_scripts() {
		...
		wp_enqueue_script(TLBM_MAIN_JS_SLUG, plugins_url("assets/js/dist/main.js", TLBM_PLUGIN_FILE));

		wp_localize_script( TLBM_MAIN_JS_SLUG, 'ajax_information',
			array(
				'url' => admin_url( 'admin-ajax.php' ),
			)
		);

		Formeditor::InsertFormelementsIntoScript(TLBM_MAIN_JS_SLUG);
		RuleActionsField::InsertRuleActionFields(TLBM_MAIN_JS_SLUG);
	...
	public function localize_constants() {
        ...
        wp_localize_script(TLBM_MAIN_JS_SLUG, "tlbm_constants",
            array(
                "months" => array(
